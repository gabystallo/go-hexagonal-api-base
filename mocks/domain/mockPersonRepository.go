...
// Source: github.com/gabystallo/go-hexagonal-api-base/domain (interfaces: PersonRepository)

// Package domain is a generated GoMock package.
package domain

import (
	domain "github.com/gabystallo/go-hexagonal-api-base/domain"
	reflect "reflect"
...
func (m *MockPersonRepository) Create(arg0 *domain.Person) error {
	m.ctrl.T.Helper()
...
func (m *MockPersonRepository) GetAll() ([]domain.Person, error) {
	m.ctrl.T.Helper()
...
func (m *MockPersonRepository) GetById(arg0 int) (*domain.Person, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPersonRepositoryMockRecorder) GetById(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetById", reflect.TypeOf((*MockPersonRepository)(nil).GetById), arg0)
}
